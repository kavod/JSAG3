...
class Test_cli(unittest.TestCase):
	@mock.patch("JSAG.Prompt2.raw_input",create=True,side_effect=['', '1', '2'])
	...
	def test_prompt_optional(self,myMockPrint,mock_input):
		...
		reponse = JSAG.Prompt2.prompt('Optinal question',default='')
	...
	@mock.patch("JSAG.Prompt2.raw_input",create=True,side_effect=['', '1', 'y', 'n'])
	@mock.patch("JSAG.Prompt2.print",create=True)
	...
	@mock.patch("JSAG.Prompt2.raw_input",create=True,side_effect=['', '1', 'n'])
	@mock.patch("JSAG.Prompt2.print",create=True)
	...
	@mock.patch("JSAG.Prompt2.raw_input",create=True,side_effect=['', 'y', '1', 'n'])
	@mock.patch("JSAG.Prompt2.print",create=True)
	...
	@mock.patch("JSAG.Prompt2.raw_input",create=True,side_effect=['', '-1', '0', '4', '3', '1'])
	@mock.patch("JSAG.Prompt2.print",create=True)
